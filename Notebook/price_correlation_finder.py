...
if __name__ == '__main__':
    ...
    data_path='/Users/nickeisenberg/GitRepos/Python_Misc/MinimalWorkingExamples/DataSets/gme_11_3_22.csv'

    top_scores = find_corr(data_csv=data_path,
                           pat_start=3232,
                           pat_end=3462)
